  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      livereload: {
        ...
        files: [
          '<%= yeoman.app %>/{,*/}*.html',
          '.tmp/styles/{,*/}*.css',<% if (includeCoffeeScript) { %>
          '.tmp/scripts/{,*/}*.js',<% } %>
    ...
    // Grunt-SASS + node-bourbon
    sass: {
      dev: {
        files: {
          '<%= yeoman.app %>/css/styles.css': '<%= yeoman.app %>/css/styles.scss'
        }
    },<% } %>
      ...
      dist: {
        files: {
          src: [
            ...
            '<%= yeoman.app %>/images/{,*/}*.{gif,jpeg,jpg,png,webp}',
